...
import com.example.stoycho.norfa.models.AutoFitTextureView;
...
public class CameraFragment extends Fragment
    ...
    private static Bitmap bitmapCapture = null;
                ...
                getActivity().runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Bitmap rotated = Bitmap.createBitmap(bitmap, 0, 0, bitmap.getWidth(), bitmap.getHeight(),
                                matrix, true);
                        capture.setImageBitmap(rotated);
                                    ...
                                    try {
                                        ...
                                        if (result.getString("status").equals("OK")) {
                                            if(getActivity() instanceof LoginActivity) {
                                                ...
                                                transaction.replace(R.id.content, registrationFragment);
    ...
    private final CameraCaptureSession.CaptureCallback mCaptureCallback
        ...
        public void onCaptureStarted(CameraCaptureSession session, CaptureRequest request,
            ...
            BitmapFactory.decodeFile(Environment.DIRECTORY_DCIM + jpegFile.getPath());
...
//                            mOnRawImageAvailableListener, mBackgroundHandler);
    ...
    private void openCamera() {
        ...
        try {
            ...
            String camId = manager.getCameraIdList()[1];
    ...
    private void createCameraPreviewSessionLocked() {
        try {
            ...
            mCameraDevice.createCaptureSession(Arrays.asList(surface,
                    mJpegImageReader.get().getSurface(),mJpegImageReader.get().getSurface()
